    ...
    return (
        <div className="relative min-h-screen flex items-center justify-center p-3 md:p-4 overflow-hidden bg-black">
            ...
            <motion.div
                ...
                className="relative z-10 w-full max-w-lg rounded-xl md:rounded-2xl shadow-2xl p-4 md:p-6 lg:p-10 border border-white/20 overflow-hidden bg-[#242424]/5 backdrop-blur-md"
            >
